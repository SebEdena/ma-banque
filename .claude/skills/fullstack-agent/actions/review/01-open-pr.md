...
2. The agent creates a pull request for the feature branch, writing the body per [[pr-template]], and reports the PR link and a summary of the implementation to the manager.
